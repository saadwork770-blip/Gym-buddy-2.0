...
const GOAL_PROFILES = {
  "Fat loss": {
    ...
    cardioIntensity: "moderate, conversational pace",
    progressionRate: 0.6,   // smaller jumps: in a deficit, strength climbs slower
    volumeTarget: "mav",
    note: "In a calorie deficit the goal is to hold strength while losing fat, so the coach makes smaller, more conservative load jumps and leans on cardio volume.",
  },
  "Muscle gain": {
    id: "hypertrophy",
    ...
    cardioIntensity: "easy, recovery pace",
    progressionRate: 1.0,
    volumeTarget: "mav",
    note: "Growth is driven by hard sets close to failure and a slow, steady climb in load. Cardio is kept light so it does not eat into recovery.",
  },
  "Strength": {
    id: "strength",
    ...
    progressionRate: 1.2,
    volumeTarget: "mev",
    note: "Heavier loads and much longer rests. Volume sits nearer the effective minimum so every set can be given full intent.",
  },
  "General fitness": {
    id: "general",
    ...
    progressionRate: 0.8,
    volumeTarget: "mav",
    note: "A balanced middle: moderate reps, moderate rest, enough cardio to keep conditioning moving.",
  },
};
